...
export async function POST(req) {
    ...
    const CHARACTER_TEXT = `generate single character image named ${name} with image style of ${comicStyle}, accessories as ${accessory},ethnicity ${ethnicity}, age group ${age}, ${facialHair} beard style and traits are ${traits}.
